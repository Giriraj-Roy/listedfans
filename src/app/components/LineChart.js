        ...
        <div className="rounded-t mb-0 px-4 py-3 bg-transparent">
          <div className="flex flex-wrap items-center bg-transparent">
            <div className="relative w-full max-w-full flex-grow flex-1 bg-transparent">
              <h6 className="bg-transparent uppercasetext-black text-blueGray-100 mb-1 text-xl font-Montserrat font-bold">
                Activities
              </h6>
              <h2 className="bg-transparent flex text-[#858585] text-base font-Montserrat font-[500]">
                May - June 2021
