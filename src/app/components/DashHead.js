  ...
  return (
    <div className='mb-[5vh] flex w-[90%]'>
        ...
        <div className='flex justify-end w-[80%] bg-inherit'>
          ...
          <svg className='h-fit my-auto' width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='my-auto mx-[2vw] w-[2vw] h-[2vw] rounded-[50%] bg-blue-600'>
        </div>     
    </div>
  )
}
