    ...
    return (
        <div className="mx-[2vw] pt-4 px-10 w-[40%] bg-white rounded-3xl">
            ...
            <div className="flex relative w-full max-w-full flex-grow flex-1 bg-transparent">
                <div className="bg-transparent text-lg w-fit font-Montserrat font-[800] capitalize ">Top Products</div>
                <div className="bg-transparent flex justify-end w-[60%] h-fit text-[#858585] text-sm font-Montserrat font-[500]">
                    May - June 2021
