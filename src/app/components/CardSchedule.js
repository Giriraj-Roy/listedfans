...
const CardSchedule = () => {
  ...
  const Event = ({startTime, endTime, title, address}) => {
    return(
      <div className='mx-4 my-3 px-2 bg-inherit
                      ...
                      font-Lato
      '>
        <div className='bg-inherit text-[#666666] text-base font-[700]'>
          {title}
        </div>
        <div className='bg-inherit text-sm text-[#999999] font-[400]'>
          {startTime}-{endTime}
          <br/>
          at {address}
        </div>
  ...
  return (
    <div className='bg-white rounded-2xl w-[40%] h-fit p-[1rem]'>
      <div className='mb-6 relative bg-inherit flex'>
        <div className='mx-4 bg-inherit text-lg text-black font-Montserrat font-[800]'>
          Today’s schedule
        </div>
        <div className='flex absolute top-0 right-[1rem] text-[#858585] font-[400] bg-inherit'>
          See All 
